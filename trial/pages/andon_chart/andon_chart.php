                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default" >
                        <div class="card-header">
                            <h3 class="card-title">Downtime Charts</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="card card-danger">
                                        <div class="card-header">
                                            <h3 class="card-title">Fault Type : Downtime</h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                    ...
                                    <div class="card card-success">
                                        <div class="card-header">
                                            <h3 class="card-title">Machine Category Wise Total Downtime (Minutes)</h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card card-danger">
                                        <div class="card-header">
                                            <h3 class="card-title">Fault Type : Occuarance</h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                    ...
                                    <div class="card card-success">
                                        <div class="card-header">
                                            <h3 class="card-title">Machine Category Wise Total Occurrence </h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                                    <i class="fas fa-minus"></i>
                                                </button>
...
<script>
   ...
   function funViewReport() 
   {
       ...
       $.post('getData_AndonChart.php', { userpara: vblSendPara }, function(json_data2) 
       {
           alert(json_data2);           
