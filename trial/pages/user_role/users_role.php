                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check mb-0">
                                ...
                                <label class="form-check-label" for="id_15"><strong>Machine Monitoring</strong></label>
                            </div>
                            <!-- Dashboard Row -->
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_151">
                                <label class="form-check-label" for="id_151">Dashboard</label>
                            </div>
                            <!-- Charts Row -->
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_152">
                                <label class="form-check-label" for="id_152">Charts</label>
                            </div>
                            <!-- Reports Row -->
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_153">
                                <label class="form-check-label" for="id_153">Reports</label>
                            </div>                           
                            <div class="form-check mb-0">
                                <input class="form-check-input" type="checkbox" value="" id="id_20">
                                <label class="form-check-label" for="id_20"><strong>Andon System</strong></label>
                            </div>
                            <!-- Charts Row -->
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_201">
                                <label class="form-check-label" for="id_202">Charts</label>
                            </div>
                            <!-- Reports Row -->
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_202">
                                <label class="form-check-label" for="id_202">Reports</label>
                            </div> 
                            <!-- Work Orders Row -->
                            <div class="form-check mb-0">
                                <input class="form-check-input" type="checkbox" value="" id="id_25">
                                <label class="form-check-label" for="id_25"><strong>Work Orders</strong></label>
                            </div>
                            <!-- Charts Row -->
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_251">
                                <label class="form-check-label" for="id_251">Charts</label>
                            </div>
                            <!-- Reports Row -->
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_252">
                                <label class="form-check-label" for="id_252">Reports</label>
                            </div> 
                            <!-- Settings Row -->
                            <div class="form-check mb-0">
                                <input class="form-check-input" type="checkbox" value="" id="id_30">
                                <label class="form-check-label" for="30"><strong>Settings</strong></label>
                            </div>
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_301">
                                <label class="form-check-label" for="id_301">Error Level Update</label>
                            </div>
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_302">
                                <label class="form-check-label" for="id_302">Machine Management</label>
                            </div>
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_303">
                                <label class="form-check-label" for="id_303">Mechanic Management</label>
                            </div>  
                           <!-- Mechanic Login Row -->
                            <div class="form-check mb-0">
                                <input class="form-check-input" type="checkbox" value="" id="id_35">
                                <label class="form-check-label" for="id_35"><strong>Mechanic Performance</strong></label>
                            </div>
                            <!-- Users Row -->
                            <div class="form-check mb-0">
                                <input class="form-check-input" type="checkbox" value="" id="id_40">
                                <label class="form-check-label" for="id_40"><strong>Users</strong></label>
                            </div>                       
                                                
                                <!-- Reports Row -->
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_401">
                                <label class="form-check-label" for="id_401">User Account</label>
                            </div>
                            <div class="form-check mb-0 ml-4">
                                <input class="form-check-input" type="checkbox" value="" id="id_402">
                                <label class="form-check-label" for="id_402">User Access</label>
                            </div>
                        </div>
                        <div class="col-md-4">
    ...
    {        
        ...
        $.post('updateData_UserRole.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")
            {
                ...
                Swal.fire({title: 'Alert !!',text: 'Data saving success.',icon: 'success', confirmButtonText: 'OK'});
            }
            else
            {
                 // success, error, warning, info, question
