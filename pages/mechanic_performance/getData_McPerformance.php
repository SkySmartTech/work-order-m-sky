    ...
    if($strFuncType === "funGetData_CheckInTable") //------------- funUpdateEventLog --------------------
    {
        ...
        {            	 
            ...
            $sqlString = "SELECT au.WorkOrderNo, 
                                ...
                                e.WoDescription,e.WorkOrderCategory,e.WorkOrderSubCategory,e.MachineNo,e.CreatedFaultType
            ...
            {   
                ...
                $ReturnData_ary[$i][6] = $row['WorkOrderSubCategory'];
                $ReturnData_ary[$i][7] = $row['MachineNo'];
                $ReturnData_ary[$i][8] = $row['CreatedFaultType'];
