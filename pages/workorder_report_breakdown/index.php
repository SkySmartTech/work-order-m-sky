            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-md-3">
                            <div class="card card-default" >                        
                                <div class="card-header">
                                    <h3 class="card-title">Breakdown Duration</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>    
                                ...
                                <div class="card-body" id="id_divBuildingMnt_chartNew1">   
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card card-default" >                        
                                <div class="card-header">
                                    <h3 class="card-title">Total Waiting Time</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>    
                                ...
                                <div class="card-body" id="id_divBuildingMnt_chartNew2"> 
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card card-default" >                        
                                <div class="card-header">
                                    <h3 class="card-title"> Department Wise Occurrence</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>    
                        ...
                        <div class="col-md-3">
                            <div class="card card-default" >  
                                <div class="card-header">
                                    <h3 class="card-title">FaultType</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>                                
                        ...
                        <div class="col-md-6">
                            <div class="card card-default" >                        
                                <div class="card-header">
                                    <h3 class="card-title">Department Wise Avarage Waiting Time</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>    
                                ...
                                <!-- /.card-header -->
                                <div class="card-body" id="id_divBuildingMnt_BarchartNew1">  
                        ...
                        <div class="col-md-12">
                            <div class="card card-default" >                        
                                <div class="card-header">
                                    <h3 class="card-title">Machine Wise Breakdown </h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>    
                                ...
                                <!-- /.card-header -->
                                <div class="card-body" id="id_divBuildingMnt_chart4">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card card-danger">  
                                        <div class="card-header">
                                            <h3 class="card-title"><b>Breakdown W/O Details</b></h3>                                    
                                        </div> 
                                    </div>
...
<script>
    ...
    { 
        ...
        $.post('getData_BdReport.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                ...
                document.getElementById("id_divBuildingMnt_chartNew1").innerHTML = '&nbsp;';
                document.getElementById("id_divBuildingMnt_chartNew1").innerHTML = '<canvas id="id_canBuildingMnt_chartNew1" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%;"></canvas>';
                ...
                var donutChartCanvas = $('#id_canBuildingMnt_chartNew1').get(0).getContext('2d');               
                var donutData = {
        ...
        $.post('getData_BdReport.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                if(intDebugEnable === 1) alert("data available");
                //--- Refres the Canvas DIV -----------------------------------------------   
                document.getElementById("id_divBuildingMnt_chartNew2").innerHTML = '&nbsp;';
                document.getElementById("id_divBuildingMnt_chartNew2").innerHTML = '<canvas id="id_canBuildingMnt_chartNew2" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%;"></canvas>';
                
                const AryCheckIn_Lable      = res.Data_Ary[0];
                const AryCheckIn_Colors   = ["red","green","#FFFF00","FFA500","#FF0FFF","#FF0000","#808080","blue","#FF00FF"," #006400","#800000","#87CEEB", "#0A0FF"];

                var donutChartCanvas = $('#id_canBuildingMnt_chartNew2').get(0).getContext('2d');               
                var donutData = {
                    labels: AryCheckIn_Lable,
                    datasets: [
                    {
    ...
    $.post('getData_BdReport.php', { userpara: DataAry }, function(json_data2) {
        ...
        if (res.Status_Ary[0] === "true") {
            ...
            var CategoryNameAry = ['Electrical', 'Mechanical', 'Select data', 'Pneumatic', 'NA'];
        ...
        $.post('getData_BdReport.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                if(intDebugEnable === 1) alert("data available");
                //--- Refres the Canvas DIV -----------------------------------------------   
                document.getElementById("id_divBuildingMnt_BarchartNew1").innerHTML = '&nbsp;';
                document.getElementById("id_divBuildingMnt_BarchartNew1").innerHTML = '<canvas id="id_canBuildingMnt_BarchartNew1" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%;"></canvas>';
                
                const AryCheckIn_Lable      = res.Data_Ary[0];
                const AryCheckIn_Colors   = ["red","green","#FFFF00","FFA500","#FF0FFF","#FF0000","#808080","blue","#FF00FF"," #006400","#800000","#87CEEB", "#0A0FF"];

                var donutChartCanvas = $('#id_canBuildingMnt_BarchartNew1').get(0).getContext('2d');               
                var donutData = {
                    labels: AryCheckIn_Lable,
                    datasets: [
                    {   
                        label               : 'Avarage Waiting',
                        data: res.Data_Ary[1],
                        backgroundColor : AryCheckIn_Colors
                    }]};
                var donutOptions = {maintainAspectRatio : false, responsive : true};
        ...
        $.post('getData_BdReport.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                if(intDebugEnable === 1) alert("data available");
                //--- Refres the Canvas DIV -----------------------------------------------   
                document.getElementById("id_divBuildingMnt_chart4").innerHTML = '&nbsp;';
                document.getElementById("id_divBuildingMnt_chart4").innerHTML = '<canvas id="id_canBuildingMnt_chart4" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%;"></canvas>';
            
                var barChartCanvas = $('#id_canBuildingMnt_chart4').get(0).getContext('2d');
                var CategoryColorAry = ['#ff0000', '#00ff00', '#0000ff', '#ffff00', '#ff00ff', '#00ffff'];
                var CategoryNameAry = ['Electrical', 'Mechanical', 'Select data', 'Pneumatic', 'NA'];
