            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="card card-default">
                                <div class="card-body" style="background: linear-gradient(to right, yellow 50%, white 50%);  border-radius: 10px; ">
                                    <div style="width: 50%; float: left; text-align: center; font-weight: bold;">Total Checking Time <br> (Hr)</div>
                                    <div style="width: 50%; float: left; text-align: center; font-size: 20px; font-weight: bold;" id="id_divTotal_checking">&nbsp; </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card card-default">
                                <div class="card-body" style="background: linear-gradient(to right, yellow 50%, white 50%);  border-radius: 10px;">
                                    <div style="width: 50%; float: left; text-align: center; font-weight: bold;">Total Allocated Time <br> (Hr)</div>
                                    <div style="width: 50%; float: left; text-align: center; font-size: 20px; font-weight: bold;" id="id_divTotal_Allocated">&nbsp;</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card card-default" >                        
                                <div class="card-header">
                                    <h3 class="card-title">Completed Workorders By Department</h3>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-minus"></i>
                                        </button>    
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card card-danger">  
                                        <div class="card-header">
                                            <h3 class="card-title"><b>Checkin Details</b></h3>                                    
                                        </div> 
                                    </div>
                        ...
                        <div class="container-fluid">                            
                            <div class="row">
                                <div class="col-12">
                                    <div class="card card-danger">  
                                        <div class="card-header">
                                            <h3 class="card-title"><b>Allocated Workorders</b></h3>                                    
                                        </div> 
                                    </div>
                                    <div class="card-body" id="id_class1">
...
<script>
    ...
    function funLoadchackingTotal() 
    {
        ...
        //-------------- Cheking MC total ------------------------------
        DataAry[0] = "funGetData_Total_checking";        // Table Name
        ...
        $.post('getData_job_History.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                ...
                document.getElementById("id_divTotal_checking").innerHTML = res.Data_Ary[0];
            

            }
            else if(res.Status_Ary[0] === "false")   // No data found, insert new record
            {
                document.getElementById("id_divTotal_checking").innerHTML = '&nbsp;';
    ...
    function funLoadAllocatedTotal() 
    {
        let intDebugEnable = 0;
        ...
        //-------------- Cheking MC total ------------------------------
        DataAry[0] = "funGetData_Total_Allocated";        // Table Name
        DataAry[1] = document.getElementById("id_startdate").value;
        DataAry[2] = document.getElementById("id_enddate").value;
        DataAry[3] = document.getElementById("id_Select_Department").value;
        DataAry[4] = document.getElementById("id_Select_Category").value;
        ...
        $.post('getData_job_History.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                if(intDebugEnable === 1) alert("data available");
                //--- Refres the Canvas DIV -----------------------------------------------   
                document.getElementById("id_divTotal_Allocated").innerHTML = res.Data_Ary[0];
            

            }
            else if(res.Status_Ary[0] === "false")   // No data found, insert new record
            {
                document.getElementById("id_divTotal_Allocated").innerHTML = '&nbsp;';
                if(intDebugEnable === 1) alert("data not available"); 
            }
            else
            {   
            ...
            if(res.Status_Ary[0] === "true")   // No data found, insert new record
            {
                ...
                var barChart2_Data2 = {
                    ...
                    datasets: [{
                        ...
                        label: 'New',
                        backgroundColor: 'Red',
                        data: res.Data_Ary[3] // Data array for Verified
                    }]
                };
    ...
    function funLoad_Departments() 
    {
        ...
        $.post('comFunctions.php', { userpara: DataAry }, function(json_data2) 
        {
            ...
            if(res.Status_Ary[0] === "true")
            {
                ...
                funLoadchackingTotal();
                funLoadAllocatedTotal();
                funLoadPieChart();
                funLoadBarChart();
                funLoadTable();
            }
    ...
    {
        let intDebugEnable = 0;        
        if(intDebugEnable === 1)    alert("funLoad_Mechanic");
