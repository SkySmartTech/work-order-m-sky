<?php
    ...
    if($strFuncType === "funGetData_PieChart1") //------------- funUpdateEventLog --------------------
    {
        ...
        $whereClause = "WorkOrderCategory = 'BreakDown' AND State < 6 AND ClosedDateTime IS NOT NULL AND CreatedDateTime BETWEEN :sdate AND :edate";
    ...
    else if($strFuncType === "funGetData_BarChart1") //------------- funUpdateEventLog --------------------
    {
        ...
        {            	 
            $sqlString = "
                ...
                FROM 
                    tblwo_event 
               WHERE " . $whereClause." GROUP BY McCategory";
    ...
    else if($strFuncType === "funGetData_Table") 
    {
        ...
        $whereClause = "wo.WorkOrderCategory = 'BreakDown' AND State < 6 AND wo.ClosedDateTime IS NOT NULL AND wo.CreatedDateTime BETWEEN :sdate AND :edate";
        ...
        { 
            ...
            foreach($result as $row)
            {
                ...
                $ReturnData_ary[$i][14] = $row['TotTimeDuration'];  
